...
class IRModule
{
    ...
    public function addGlobal(string $name, string $type, int $size, ?string $initValue = null, ?string $stringData = null): void
    {
        $this->globals[] = new IRGlobal($name, $type, $size, $initValue, $stringData);
    }
